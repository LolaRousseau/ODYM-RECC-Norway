...
@author: spauliuk
Last update: Lola Rousseau - March 2025
"""

"""

File ODYM_RECC_ScenarioControl.py
...
while ModelConfigListSheet.cell(Row+1, 3).value != None:
    ...
    sheet['D104'] = Config['Population_Model']
    sheet['D105'] = Config['Climate_Scenario']
    sheet['D106'] = Config['Include_Renovation_reb']
    sheet['D107'] = Config['Renovation_Scenario']
    sheet['D108'] = Config['Include_Renovation_reb_energy']
    sheet['D109'] = Config['Electricity_Mix']
    
    sheet['D114'] = Config['Save graphs']
    sheet['D115'] = Config['Save dat']
    sheet['D116'] = Config['PlotResolution']
